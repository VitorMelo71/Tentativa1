        ...
        <html>
          <head>
            ...
            <script>
              ...
              window.updateMarker = updateMarker;  // Define a função global para poder ser chamada externamente
            </script>
          </head>
          <body onload="initMap()">
...
# Atualiza a posição do veículo sem recarregar o mapa inteiro
